...
/* ══════════════════════════════════════════
   STORAGE HELPERS (LocalStorage simulation with in-memory fallback)
══════════════════════════════════════════ */
const Store = {
...
// Demo repairs for first-time users
...
// Location
document.getElementById('location-icon').addEventListener('click', () => showToast('📍 Ubicación detectada: Yopal, Casanare'));
